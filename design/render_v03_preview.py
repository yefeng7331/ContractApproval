"""Render a lightweight v0.3 contact sheet for visual QA of pencil-new.pen."""
...
for number, board in enumerate(DATA["children"], start=1):
    ...
    if number in {2, 3, 8, 10}:
        canvas.save(ROOT / "design" / f"v0.3-board-{number:02d}.png")
...
out = ROOT / "design" / "v0.3-preview.png"
sheet.save(out)
print(out)
